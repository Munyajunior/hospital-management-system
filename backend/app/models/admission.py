...
class PatientAdmission(Base):
    ...
    assigned_doctor = relationship("User", foreign_keys=[admitted_by])
    department = relationship("Department")
    ward = relationship("Ward")
    bed = relationship("Bed", back_populates="patient_admission")
...
class Bed(Base):
    ...
    patient_admission = relationship("PatientAdmission", back_populates="bed")
